...
const tarotCards = [
  {
    ...
    reading: "완벽하게 준비되지 않았다고 해서 멈춰있을 필요는 없습니다.\n\n새해에는 계산을 내려놓고 가벼운 마음으로 미지의 길에 발을 디디게 되는데, 그 엉뚱하고 대담한 무모함이 오히려 생각지도 못한 행운의 문을 열어젖힐 거예요.",
  ...
  },
  {
    ...
    reading: "머릿속으로만 구상하던 일들을 새해에는 드디어 손에 잡히는 결과물로 증명해 내는 시기입니다.\n\n당신이 가진 기술과 언변, 그리고 수많은 자원들이 비로소 제자리를 찾아 강력한 시너지를 발휘하게 됩니다.",
  ...
  },
  {
    ...
    reading: "세상의 요란한 소음 속에서 한 발짝 물러나 사물의 본질을 꿰뚫어 보는 새해입니다.\n\n논리로는 설명하기 힘든 강한 육감과 직관이 위기나 중요한 선택의 순간마다 정확한 등대 역할을 해줄 거예요.",
  ...
  },
  {
    ...
    reading: "오랫동안 공들여 가꾼 일상과 관계 속에서 비옥한 대지 같은 결실이 새해에 차오릅니다.\n\n물질적·정서적인 여유가 찾아오며, 주변을 너그럽게 품어줄 수 있는 따스한 포용력이 빛을 발하는 시기에요.",
    advice: "조급하게 서두르지 않아도 됩니다. 무르익는 과정을 편안하게 누릴 자격이 충분합니다.",
  ...
  },
  {
    ...
    reading: "감정에 휘둘리지 않는 냉철한 결단력으로 혼란스러운 판을 단단하게 다잡는 새해입니다.\n\n확고한 원칙을 세워 주변 환경을 장악하고, 리더로서 가치 있는 타이틀과 성과를 거머쥐게 됩니다.",
  ...
  },
  {
    ...
    reading: "혼자서 맨땅에 헤딩하는 시행착오를 겪기보다, 지혜로운 조력자나 신뢰할 수 있는 시스템 속에서 확실한 성장을 이뤄냅니다.\n\n새해에는 이미 길을 걸어본 이들의 묵직한 조언이 앞날을 환히 밝혀줄 거예요.",
  ...
  },
  {
    ...
    advice: "타인의 시선이 아니라, 내 가슴이 진정으로 고르는 선택이 무엇인지 집중하세요.",
  ...
  },
  {
    ...
    reading: "치열한 경쟁이나 팽팽한 대립 속에서 한 치의 양보도 없이 기어코 승리를 따내는 새해 시기입니다.\n\n흩어져 있던 의지를 하나로 모아 속도감 있게 밀어붙이면, 지루했던 정체기도 단숨에 끝이 납니다.",
  ...
  },
  {
    ...
    reading: "새해에는 세상의 소란스러움에서 잠시 발을 빼고, 나만의 등불을 켜 들고 내면을 깊이 들여다보는 시기를 가집니다.\n\n겉멋과 허세를 다 걷어내고 삶의 진짜 알짜배기 가치를 발견하는 고요한 깨달음의 시간이에요.",
  ...
  },
  {
    ...
    reading: "내 힘으로 어쩔 수 없던 정체된 판이 거대한 운명의 흐름을 타고 극적으로 재편됩니다.\n\n새해에는 생각지도 못한 순간, 절묘한 타이밍에 다가오는 기회가 삶의 궤도를 유쾌하고 이롭게 틀어놓을 거예요.",
  ...
  },
  {
    ...
    reading: "진행하던 일이 새해에 의도치 않게 브레이크가 걸리며 답답한 정체기를 지나는 듯 보이지만, 사실 이는 하늘이 준 휴식입니다.\n\n기존의 방식을 완전히 뒤집어 보는 신선한 통찰을 얻게 되는 계기가 돼요.",
  ...
  },
  {
    ...
    reading: "극단으로 치닫는 감정과 상황 속에서 절묘하게 타협점을 찾아내며 평정심을 되찾습니다.\n\n겉으로 요란하지는 않지만 물 흐르듯 유연하게 새해 일상의 균형을 맞추며 최적의 안정을 누리게 될 거예요.",
  ...
  },
  {
    ...
    reading: "그동안 나를 은근히 옭아매던 나쁜 루틴이나 해로운 집착의 실체를 새해에 명확히 깨닫고 통쾌하게 끊어내는 시기입니다.\n\n족쇄인 줄 알았던 굴레가 사실은 내가 쥐고 있었음을 깨닫는 순간, 비로소 진짜 자유가 찾아옵니다.",
  ...
  },
  {
    ...
    reading: "과거에 아쉽게 놓쳤거나 미뤄두었던 일에 대해 새해에는 하늘이 준 두 번째 기회, 즉 멋진 부활의 서막이 열립니다.\n\n그간 흘린 땀방울이 정확한 평가를 받으며 사람들의 뜨거운 환호와 축하를 이끌어내요.",
  ...
  },
  {
    ...
    reading: "오랫동안 공들여온 거대한 여정의 조각들이 새해에 마침내 완벽하게 제자리를 찾아 하나의 아름다운 풍경을 완성합니다.\n\n모든 사이클이 성공적으로 마무리되며, 누구나 부러워할 만한 깊은 성취감과 축제를 맞이하게 돼요.",
